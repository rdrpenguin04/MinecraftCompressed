...
public class BuiltinHelpFormatter implements HelpFormatter {
	...
	public String format(Map<String, ? extends OptionDescriptor> options) {
		Comparator<OptionDescriptor> comparator = new Comparator() {
			public int compare(Object first, Object second) {
				return ((String) ((OptionDescriptor) first).options().iterator().next())
						.compareTo((String) ((OptionDescriptor) second).options().iterator().next());
			}
		};
	...
	private void appendTypeIndicator(StringBuilder buffer, String typeIndicator, String description, char start,
			char end) {
	...
	private String createDescriptionDisplay(OptionDescriptor descriptor) {
		...
		return (descriptor.description() + ' ' + Strings
				.surround(new StringBuilder().append("default: ").append(defaultValuesDisplay).toString(), '(', ')'))
						.trim();
	}
